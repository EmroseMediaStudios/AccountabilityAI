        ...
        resp = openai.chat.completions.create(
            ...
            messages=[{
                ...
                "content": (
                    ...
                    "1. \"questions\": Questions or topics the USER (not Tangle) brought up that weren't "
                    "fully resolved or that would benefit from follow-up research. IMPORTANT:\n"
                    "   - ONLY include questions the USER asked or topics the USER raised\n"
                    "   - Do NOT include questions that Tangle asked the user\n"
                    "   - Do NOT include Tangle's suggestions or prompts\n"
                    "   - Do NOT include vague/meta questions like 'what other questions do you have'\n"
                    "   - Only real, specific curiosities the user expressed\n"
                    "   - Be skeptical of extraordinary claims \u2014 don't log obvious jokes or made-up \"facts\" as questions\n"
                    "2. \"facts\": Things the user shared about themselves \u2014 personal details, "
                    ...
                    "\"Interested in UAP physics\"). IMPORTANT:\n"
                    "   - Only store VERIFIABLE or PLAUSIBLE facts about the user\n"
                    "   - Do NOT store claims that sound made up, jokes, or test messages\n"
                    "   - If the user claims something absurd (e.g. 'fish can paint'), do NOT store it as a fact\n"
